...
batches = "240717_Lib_28region"
batches = "240710_Lib_37region" # Done
if batches == '240409_Lib_embryo':
  mp_r1 = project_dir / 'inputs/240409_Lib_embryo/00.mergeRawFq' / batches / '240409_Lib_embryo_raw_1.fq.gz'
  mp_r2 = project_dir / 'inputs/240409_Lib_embryo/00.mergeRawFq' / batches / '240409_Lib_embryo_raw_2.fq.gz'
  ...
  mp_r1 = project_dir / 'inputs/20240321_null_1/00.mergeRawFq' / batches / '20240321_Lib_Embryo_raw_1.fq.gz'
  mp_r2 = project_dir / 'inputs/20240321_null_1/00.mergeRawFq' / batches / '20240321_Lib_Embryo_raw_2.fq.gz'
  sample_info_tab = project_dir / 'outputs/analysis/preprocessing/barcodes' / (batches + '.sample_barcode.txt')
elif batches == '20240321_Lib_20ng':
  mp_r1 = project_dir / 'inputs/20240321_null_1/00.mergeRawFq' / batches / '20240321_Lib_20ng_raw_1.fq.gz'
  mp_r2 = project_dir / 'inputs/20240321_null_1/00.mergeRawFq' / batches / '20240321_Lib_20ng_raw_2.fq.gz'
  sample_info_tab = project_dir / 'outputs/analysis/preprocessing/barcodes' / (batches + '.sample_barcode.txt')
elif batches == '20240321_Lib_100cells':
  mp_r1 = project_dir / 'inputs/20240321_null_1/00.mergeRawFq' / batches / '20240321_Lib_100cells_raw_1.fq.gz'
  mp_r2 = project_dir / 'inputs/20240321_null_1/00.mergeRawFq' / batches / '20240321_Lib_100cells_raw_2.fq.gz'
  sample_info_tab = project_dir / 'outputs/analysis/preprocessing/barcodes' / (batches + '.sample_barcode.txt')
elif batches == '240612_Lib_28region':
  mp_r1 = project_dir / 'inputs/240612_Lib_28region/00.mergeRawFq' / batches / '240612_Lib_28region_raw_1.fq.gz'
  mp_r2 = project_dir / 'inputs/240612_Lib_28region/00.mergeRawFq' / batches / '240612_Lib_28region_raw_2.fq.gz'
  sample_info_tab = project_dir / 'outputs/analysis/preprocessing/barcodes' / (batches + '.sample_barcode.txt')
elif batches == '240612_Lib_28region_purified':
  mp_r1 = project_dir / 'inputs/240612_Lib_28region/00.mergeRawFq' / batches / '240612_Lib_28region_raw_1_p.fq.gz'
  mp_r2 = project_dir / 'inputs/240612_Lib_28region/00.mergeRawFq' / batches / '240612_Lib_28region_raw_2_p.fq.gz'
  sample_info_tab = project_dir / 'outputs/analysis/preprocessing/barcodes' / (batches + '.sample_barcode.txt')
elif batches == '240620_Lib_38region':
  mp_r1 = project_dir / 'inputs/240620_Lib_38region/00.mergeRawFq' / batches / '240620_Lib_38region_raw_1.fq.gz'
  mp_r2 = project_dir / 'inputs/240620_Lib_38region/00.mergeRawFq' / batches / '240620_Lib_38region_raw_2.fq.gz'
  sample_info_tab = project_dir / 'outputs/analysis/preprocessing/barcodes' / (batches + '.sample_barcode.txt')
elif batches == '240703_Lib_32region':
  mp_r1 = project_dir / 'inputs' / batches / '00.mergeRawFq' / batches / '240703_Lib_32region_raw_1.fq.gz'
  mp_r2 = project_dir / 'inputs' / batches / '00.mergeRawFq' / batches / '240703_Lib_32region_raw_2.fq.gz'
  sample_info_tab = project_dir / 'outputs/analysis/preprocessing/barcodes' / (batches + '.sample_barcode.txt')
elif batches == "E200022670-IAA_mix":
  mp_r1 = project_dir / 'inputs' / batches / 'IAA-mix_IAA-mix_1.fq.gz'
  mp_r2 = project_dir / 'inputs' / batches / 'IAA-mix_IAA-mix_2.fq.gz'
  sample_info_tab = project_dir / 'outputs/analysis/preprocessing/barcodes' / (batches + '.sample_barcode.txt')
elif batches == "240710_Lib_37region":
  mp_r1 = project_dir / 'inputs' / batches / '00.mergeRawFq' / batches / '240710_Lib_37region_raw_1.fq.gz'
  mp_r2 = project_dir / 'inputs' / batches / '00.mergeRawFq' / batches / '240710_Lib_37region_raw_2.fq.gz'
  sample_info_tab = project_dir / 'outputs/analysis/preprocessing/barcodes' / (batches + '.sample_barcode.txt')
elif batches == "240717_Lib_28region":
  mp_r1 = project_dir / 'inputs' / batches / '00.mergeRawFq' / batches / '240717_Lib_28region_raw_1.fq.gz'
  mp_r2 = project_dir / 'inputs' / batches / '00.mergeRawFq' / batches / '240717_Lib_28region_raw_2.fq.gz'
  sample_info_tab = project_dir / 'outputs/analysis/preprocessing/barcodes' / (batches + '.sample_barcode.txt')
else:
...
# Outputs
dm_dir = project_dir / 'outputs/analysis/preprocessing/demultiplexing' / batches 
qc_dir = project_dir / 'outputs/analysis/preprocessing/quality_control' / batches 
ra_dir = project_dir / 'outputs/analysis/preprocessing/read_alignments' / batches 
qt_dir = project_dir / 'outputs/analysis/preprocessing/quantification' / batches 
nr_dir = project_dir / 'outputs/analysis/preprocessing/nascent_rna' / batches 
mq_dir = project_dir / 'outputs/analysis/preprocessing/alignment_statistics' / batches 
vc_dir = project_dir / 'outputs/analysis/preprocessing/velocity_counts' / batches 
...
rule s01_demultiplexing:
  ...
  shell:
    '''
    fastq-multx -b -B {input.sample_info_tab} {input.read_1} {input.read_2} -o {params.output_dir}/%.R1.fq.gz -o {params.output_dir}/%.R2.fq.gz
